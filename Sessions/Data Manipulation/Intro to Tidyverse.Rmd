...
```{r Libraries, eval=F,echo=T, warning=F, message=F}
...
```{r unite, echo=t, eval=F, warning=F}
...
```{r, graphic_example, eval = F, echo = T}
...
```{r pi-pi-pi-piping, echo =T, eval=F}
...
```{r Combo, echo =T, eval=F, warning=F, message=F}
